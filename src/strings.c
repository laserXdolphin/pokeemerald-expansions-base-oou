...
const u8 gText_Unknown[] = _("Unkown");
...
const u8 gText_Stats_eggGroup_WATER_2[]     = _("Watter {CIRCLE_2}");
...
const u8 gText_FORMS_Buttons_Decapped_PE[]          = _("{A_BUTTON}Form Mode  {START_BUTTON}Evos");
const u8 gText_FORMS_Buttons_Submenu_PE[]           = _("{DPAD_NONE}FORMs {A_BUTTON}CHECK {START_BUTTON}EVOs");
const u8 gText_FORMS_Buttons_Submenu_Decapped_PE[]  = _("{DPAD_NONE}Forms {A_BUTTON}Check {START_BUTTON}Evos");
